...
describe('GalleryApplication', () => {
  it('should create a personal gallery if owner exists', async () => {
    const body = {
      name: 'test gallery',
      owner: '6e9b27dc-7e9d-48dd-a64b-c49f014b9fb9',
    };

    const gallery = new GalleryApplication();
    const result = await gallery.createGallery(body);
  ...
  it('should not allow to delete a gallery if it contains elements inside', async () => {
    ...
    const gallery = new GalleryApplication();
    const result = await gallery.deleteGallery(body);
  ...
  it('should delete one or more NFTs from the gallery', async () => {
    const body = {
      galleryId: '7828e6cc-fc0e-4477-9625-02fedca814d8',
      nftId: '55aee5fb-00d6-48f0-897e-eeec36e050b9',
    };

    const gallery = new GalleryApplication();
    const result = await gallery.deleteNFT(body);
  ...
  it('should list all NFTs in a gallery', async () => {
    ...
    const gallery = new GalleryApplication();
    const result = await gallery.listNFT(body);
